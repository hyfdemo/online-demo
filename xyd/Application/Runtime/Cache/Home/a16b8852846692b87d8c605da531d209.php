...
<body>
	<div class="iframe-header">
		<ul class="breadcrumb">
			...
			<li><i class="fa fa-angle-right"></i>领导班子</li>
		</ul>
	</div>
	<div class="iframe-content p20">
		<div class="js_pageshow">
			<div class="search-row">
				...
				<input type="text" name="search" class="search-field" placeholder="输入领导名字、职称">
			...
			<div class="operate-row">
				<div class="operate-left">
					...
					<button type="button" class="btn btn-blue btn-add"><i class="fa fa-plus"></i>新增领导</button>
				</div>
...
<script>
    ...
    function setEditTableData(data, isView) {
        $('#uname').val(data.name);
        $('#avatar').attr('src', data.head).show();
    ...
    (function(){
        ...
        $('.js_search').click(function(){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo U('Admin/lea_search');?>",
        ...
        $('.btn-confirm').click(function(){
            var state = $(this).attr('data-state'),
                    url = '';
            if (state == 'edit') {  // 编辑
                url = "<?php echo U('Admin/lea_edit');?>";  // 编辑教师提交的url
            } else if (state == 'add') {  // 新增
                url = "<?php echo U('Admin/lea_add');?>";  // 新增教师提交的url
            }
