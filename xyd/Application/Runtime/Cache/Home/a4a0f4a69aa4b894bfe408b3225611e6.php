...
<body>
	<div class="iframe-header">
		<ul class="breadcrumb">
			...
			<li><i class="fa fa-angle-right"></i>学校荣誉</li>
		</ul>
	</div>
	...
	<div class="iframe-content">
		<div class="edit-wrapper">
            ...
            <div id="con" style="display: none"><?php echo ($honor); ?></div>
		</div>
	</div>
	...
	<script>
		$(function(){
            ...
            um.setWidth(800);
            um.setHeight(250);
            um.setContent((content == '' || content == null) ? '<p style="color: #999;">输入学校荣誉内容</p>' : content);
            ...
            $('.js_confirm').click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo U('Admin/honor_add');?>",
                    data: {content: text},
