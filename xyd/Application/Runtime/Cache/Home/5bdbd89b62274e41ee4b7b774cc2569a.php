...
<style type="text/css">
	...
	.text_cn{width: 100%;height: auto;margin: 0 auto;font-size: 16px;}
...
<div id="container"> 
	...
	<div class="main">
		<div class="jiaoshi">
			...
			<div class="jiaoshi_name">姓名：<?php echo ($data["name"]); ?></div>
			<div class="text_cn"><?php echo ($data["content"]); ?></div>
		</div>
	</div>
</div>
</body>
